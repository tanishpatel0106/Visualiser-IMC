...
export const INDICATORS: IndicatorDef[] = [
  ...
  { id: 'AO', name: 'Awesome Oscillator', shortName: 'AO', category: 'momentum', placement: 'pane', description: 'Median price momentum', color: C.green, params: [{ name: 'fast', label: 'Fast', type: 'int', default: 5, min: 2, max: 50 }, { name: 'slow', label: 'Slow', type: 'int', default: 34, min: 5, max: 200 }], requires: ['highs', 'lows'] },
  { id: 'AC', name: 'Accelerator Oscillator', shortName: 'AC', category: 'momentum', placement: 'pane', description: 'Momentum change of AO', color: C.pink, params: [{ name: 'fast', label: 'Fast', type: 'int', default: 5, min: 2, max: 50 }, { name: 'slow', label: 'Slow', type: 'int', default: 34, min: 5, max: 200 }], requires: ['highs', 'lows'] },
  ...
  { id: 'CRSI', name: 'Connors RSI', shortName: 'CRSI', category: 'momentum', placement: 'pane', description: 'Composite short-term reversal osc', color: C.indigo, params: [{ name: 'rsiPeriod', label: 'RSI Period', type: 'int', default: 3, min: 2, max: 50 }, { name: 'streakPeriod', label: 'Streak', type: 'int', default: 2, min: 1, max: 20 }, { name: 'rankPeriod', label: 'Rank', type: 'int', default: 100, min: 10, max: 500 }] },
  ...
  { id: 'SCHAFF', name: 'Schaff Trend Cycle', shortName: 'STC', category: 'momentum', placement: 'pane', description: 'Fast cycle/trend transition', color: C.emerald, params: [{ name: 'fast', label: 'Fast EMA', type: 'int', default: 23, min: 2, max: 100 }, { name: 'slow', label: 'Slow EMA', type: 'int', default: 50, min: 5, max: 200 }, { name: 'cyclePeriod', label: 'Cycle', type: 'int', default: 10, min: 2, max: 50 }] },
  ...
  { id: 'MASS_INDEX', name: 'Mass Index', shortName: 'MI', category: 'momentum', placement: 'pane', description: 'Range expansion/reversal study', color: C.orange, params: [{ name: 'emaPeriod', label: 'EMA Period', type: 'int', default: 9, min: 2, max: 50 }, { name: 'sumPeriod', label: 'Sum Period', type: 'int', default: 25, min: 5, max: 100 }], requires: ['highs', 'lows'] },
  { id: 'COPPOCK', name: 'Coppock Curve', shortName: 'Coppock', category: 'momentum', placement: 'pane', description: 'Long-turn momentum study', color: C.teal, params: [{ name: 'longRoc', label: 'Long ROC', type: 'int', default: 14, min: 2, max: 100 }, { name: 'shortRoc', label: 'Short ROC', type: 'int', default: 11, min: 2, max: 100 }, { name: 'wmaPeriod', label: 'WMA Period', type: 'int', default: 10, min: 2, max: 50 }] },
  { id: 'KST', name: 'Know Sure Thing', shortName: 'KST', category: 'momentum', placement: 'pane', description: 'Blended multi-horizon momentum', color: C.purple, colors: [C.purple, C.orange], outputs: 2, outputNames: ['KST', 'Signal'], params: [{ name: 'r1', label: 'ROC 1', type: 'int', default: 10, min: 2, max: 50 }, { name: 'r2', label: 'ROC 2', type: 'int', default: 15, min: 2, max: 75 }, { name: 'r3', label: 'ROC 3', type: 'int', default: 20, min: 2, max: 100 }, { name: 'r4', label: 'ROC 4', type: 'int', default: 30, min: 2, max: 150 }, { name: 'sigPeriod', label: 'Signal', type: 'int', default: 9, min: 2, max: 50 }] },
  ...
  { id: 'SQUEEZE', name: 'Squeeze Momentum', shortName: 'Squeeze', category: 'momentum', placement: 'pane', description: 'Squeeze-release momentum monitor', color: C.cyan, params: [{ name: 'bbPeriod', label: 'BB Period', type: 'int', default: 20, min: 2, max: 100 }, { name: 'bbMult', label: 'BB Mult', type: 'float', default: 2, min: 0.5, max: 5 }, { name: 'kcPeriod', label: 'KC Period', type: 'int', default: 20, min: 2, max: 100 }, { name: 'kcMult', label: 'KC Mult', type: 'float', default: 1.5, min: 0.5, max: 5 }], requires: ['highs', 'lows'] },
